        ...
        <>
           <div className="container">
               ...
               <div style={{position:"absolute",top:"250px",height:"60px",width:"60px", borderRadius:"50%",overflow:"hidden",objectFit:"coverS"}}>
                   <img src="https://t3.ftcdn.net/jpg/04/49/25/36/360_F_449253617_hHCzo5axDbfAoNIrmEHTWg1ar2fC5DMW.jpg" alt="" style={{height:"84px",width:"84px",position:"absolute",top:"-12px",left:"-12px"}}/></div>
